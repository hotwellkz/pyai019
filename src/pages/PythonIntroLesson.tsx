                ...
                <div className="space-y-4">
                  <div className="flex flex-wrap gap-2">
                    {suggestedQuestions.map((question, index) => (
                      <button
                        ...
                        className="bg-blue-50 hover:bg-blue-100 text-blue-600 px-4 py-2 rounded-lg text-sm transition-colors"
                      >
                        {question}
                      </button>
                    ))}
                  ...
                  <div className="flex gap-2">
                    <input
                      ...
                      className="flex-1 px-4 py-2 border border-slate-200 rounded-lg focus:ring-2 focus: ```
ring-blue-500 focus:border-blue-500"
                    />
                    <button
                      onClick={handlePromptSubmit}
                      disabled={!promptInput.trim() || tokens < 5}
                      className="bg-blue-500 hover:bg-blue-600 text-white px-6 py-2 rounded-lg transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2"
                    >
                      {isLoading ? (
                        <>
