        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-8 hover:transform hover:scale-105 transition-all duration-300 border border-blue-100 hover:border-blue-300 hover:shadow-xl relative group">
              ...
              <button className="w-full bg-gradient-to-r from-blue-500 to-purple-500 hover:from-blue-600 hover:to-purple-600 text-white font-medium py-3 px-4 rounded-xl transition-all duration-300 transform hover:scale-105 hover:shadow-lg mb-6 relative overflow-hidden group">
            ...
            <div className="bg-gradient-to-br from-slate-900 to-blue-900 rounded-2xl shadow-xl p-8 transform hover:scale-110 transition-all duration-300 relative group border border-blue-500/30">
              ...
              <button className="w-full bg-gradient-to-r from-blue-400 to-purple-400 hover:from-blue-500 hover:to-purple-500 text-white font-medium py-3 px-4 rounded-xl transition-all duration-300 transform hover:scale-105 hover:shadow-lg mb-6 relative overflow-hidden group">
            ...
            <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-8 hover:transform hover:scale-105 transition-all duration-300 border border-purple-100 hover:border-purple-300 hover:shadow-xl relative group">
              ...
              <button className="w-full bg-gradient-to-r from-purple-500 to-pink-500 hover:from-purple-600 hover:to-pink-600 text-white font-medium py-3 px-4 rounded-xl transition-all duration-300 transform hover:scale-105 hover:shadow-lg mb-6 relative overflow-hidden group">
